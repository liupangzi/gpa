// antlr -Dlanguage=Go DeleteStatementParser.g4 -o . -package deleteparser

grammar DeleteStatementParser;
...
deleteStatement
    : Delete fromClause whereClause? orderByClause? limitClause?
    ;

fromClause
    : From table=(BackQuotedString | RawString) (As alias=(BackQuotedString | RawString))?
    ;
