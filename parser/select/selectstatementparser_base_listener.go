...
func (s *BaseSelectStatementParserListener) EnterLikeExpression(ctx *LikeExpressionContext) {}

// ExitLikeExpression is called when production likeExpression is exited.
func (s *BaseSelectStatementParserListener) ExitLikeExpression(ctx *LikeExpressionContext) {}

// EnterCompareExpression is called when production compareExpression is entered.
func (s *BaseSelectStatementParserListener) EnterCompareExpression(ctx *CompareExpressionContext) {}

// ExitCompareExpression is called when production compareExpression is exited.
func (s *BaseSelectStatementParserListener) ExitCompareExpression(ctx *CompareExpressionContext) {}
...
func (s *BaseSelectStatementParserListener) EnterColonField(ctx *ColonFieldContext) {}

// ExitColonField is called when production colonField is exited.
func (s *BaseSelectStatementParserListener) ExitColonField(ctx *ColonFieldContext) {}
